package com.weatherbuddy.core.network;
 ...
 * To make http request asynchronous, this class uses Robospice where
 * request are made in thread of the Robospice Service.
 */
